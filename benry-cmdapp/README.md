...
```console
[bash]$ ruby ex19.rb foo:              # !!!!
Actions:
  foo:test2          : test action #2

[bash]$ ruby ex19.rb bar:              # !!!!
Actions:
  bar:baz:test4      : test action #4
  bar:test3          : test action #3
```
...
```console
[bash]$ ruby ex22.rb -h test1
ex22.rb test1 --- test action

Usage:
  $ ex22.rb test1 [<options>]
...
config.app_command          = "ex23.rb"             # == File.basename($0)
...
```console
[bash]$ ruby ex33.rb -h hello
ex33.rb hello --- test action #1
