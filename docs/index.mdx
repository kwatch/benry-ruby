...
(NOTICE: Gem package is renamed from [benry-unixcmd](https://rubygems.org/gems/benry-unixcmd) to [benry-unixcommand](https://rubygems.org/gems/benry-unixcommand) since release 1.0.)
